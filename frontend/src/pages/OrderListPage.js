...
const ProductListPage = ({ history, match }) => {
	...
	// refresh access tokens if user details fail
	useEffect(() => {
	...
	return (
		...
		<div className="tabs">
			...
			<label htmlFor="tabone">All Orders</label>
			<div className="tab">
			...
			<label htmlFor="tabtwo">All Sales</label>
			<div className="tab">
				<Row className='align-items-center'>
					<Col>
						<h1>Sales by Date({`${total || 0}`})</h1>
					</Col>
				</Row>
				{loading ? (
					<Loader />
			...
			<label htmlFor="tabthree">All Purchases</label>
			<div className="tab">
				<Row className='align-items-center'>
					<Col>
						<h1>Your Purchases ({`${total || 0}`})</h1>
					</Col>
				</Row>
				{loading ? (
					<Loader />
