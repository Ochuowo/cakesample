...
export const ORDER_STUDENT_LIST_REQUEST = 'ORDER_STUDENT_LIST_REQUEST';
export const ORDER_STUDENT_LIST_SUCCESS = 'ORDER_STUDENT_LIST_SUCCESS';
export const ORDER_STUDENT_LIST_FAILURE = 'ORDER_STUDENT_LIST_FAILURE';
export const ORDER_STUDENT_LIST_RESET = 'ORDER_STUDENT_LIST_RESET';
