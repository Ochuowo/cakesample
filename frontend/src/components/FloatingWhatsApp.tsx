import React, {
  ...
  import css from "../styles/whatsApp.module.css";
  ...
  export default interface FloatingWhatsAppProps {
  ...
  export function FloatingWhatsApp({
    ...
    notificationSoundSrc = "./assets/whatsapp-notification.mp3",
    style,
    buttonStyle,
    chatboxStyle,
