	...
	getStudent = async () => {
		...
		try {
			...
			if (res.data.student.class.length < 1) {
				const doneObj = {
					message: 'This Student is not in class, you should appoint a class for him/her',
					type: 'warning'
				};
				...
				{this.state.student && (
					<div>
						...
						<ul style={{ fontSize: '1.2rem' }}>
							...
							<li>
								<span style={{ fontWeight: 'bold' }}>Password</span>: {this.state.student.password}
							</li>
							<li>
								<span style={{ fontWeight: 'bold' }}>Gender</span>: {this.state.student.gender}
							</li>
							<li>
								<span style={{ fontWeight: 'bold' }}>IsConfirmed</span>: {this.state.student.isConfirmed}
							</li>
							<li>
								<span style={{ fontWeight: 'bold' }}>Avatar</span>: {this.state.student.avatar}
							</li>
							<li>
